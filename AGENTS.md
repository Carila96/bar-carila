...
- Never commit API keys. Runtime credentials must be Cloudflare Workers secrets (and Vercel environment variables while the fallback deployment remains active).
