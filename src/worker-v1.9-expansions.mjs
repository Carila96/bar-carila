...
const EXPANSION_BATCHES = [
  ...
  { id: 'B23', drinks: DRINK_MASTER_EXPANSION_B23, evidenceVersion: DRINK_MASTER_EXPANSION_B23_EVIDENCE_VERSION, evaluatedAt: DRINK_MASTER_EXPANSION_B23_EVALUATED_AT },
];
