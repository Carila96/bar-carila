...
import { DRINK_MASTER_EXPANSION_B20, DRINK_MASTER_EXPANSION_B20_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B20_EVALUATED_AT } from './drink-master-expansion-b20-approved.mjs';
import { DRINK_MASTER_EXPANSION_B21, DRINK_MASTER_EXPANSION_B21_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B21_EVALUATED_AT } from './drink-master-expansion-b21-approved.mjs';
import { DRINK_MASTER_EXPANSION_B22, DRINK_MASTER_EXPANSION_B22_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B22_EVALUATED_AT } from './drink-master-expansion-b22-approved.mjs';
...
import { DRINK_MASTER_EXPANSION_B30, DRINK_MASTER_EXPANSION_B30_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B30_EVALUATED_AT } from './drink-master-expansion-b30-approved.mjs';
import { DRINK_MASTER_EXPANSION_B31, DRINK_MASTER_EXPANSION_B31_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B31_EVALUATED_AT } from './drink-master-expansion-b31-approved.mjs';
import { DRINK_MASTER_EXPANSION_B32, DRINK_MASTER_EXPANSION_B32_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B32_EVALUATED_AT } from './drink-master-expansion-b32-approved.mjs';
import { DRINK_MASTER_EXPANSION_B33, DRINK_MASTER_EXPANSION_B33_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B33_EVALUATED_AT } from './drink-master-expansion-b33-approved.mjs';
import { DRINK_MASTER_EXPANSION_B34, DRINK_MASTER_EXPANSION_B34_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B34_EVALUATED_AT } from './drink-master-expansion-b34-approved.mjs';
import { DRINK_MASTER_EXPANSION_B35, DRINK_MASTER_EXPANSION_B35_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B35_EVALUATED_AT } from './drink-master-expansion-b35-approved.mjs';
import { DRINK_MASTER_EXPANSION_B36, DRINK_MASTER_EXPANSION_B36_EVIDENCE_VERSION, DRINK_MASTER_EXPANSION_B36_EVALUATED_AT } from './drink-master-expansion-b36-approved.mjs';
...
const EXPANSION_BATCHES = [
  ...
  { id: 'B20', drinks: DRINK_MASTER_EXPANSION_B20, evidenceVersion: DRINK_MASTER_EXPANSION_B20_EVIDENCE_VERSION, evaluatedAt: DRINK_MASTER_EXPANSION_B20_EVALUATED_AT },
  { id: 'B21', drinks: DRINK_MASTER_EXPANSION_B21, evidenceVersion: DRINK_MASTER_EXPANSION_B21_EVIDENCE_VERSION, evaluatedAt: DRINK_MASTER_EXPANSION_B21_EVALUATED_AT },
  { id: 'B22', drinks: DRINK_MASTER_EXPANSION_B22, evidenceVersion: DRINK_MASTER_EXPANSION_B22_EVIDENCE_VERSION, evaluatedAt: DRINK_MASTER_EXPANSION_B22_EVALUATED_AT },
  { id: 'B39', drinks: DRINK_MASTER_EXPANSION_B39, evidenceVersion: DRINK_MASTER_EXPANSION_B39_EVIDENCE_VERSION, evaluatedAt: DRINK_MASTER_EXPANSION_B39_EVALUATED_AT },
];
...
const B30_BATCH={ id:'B30', drinks:DRINK_MASTER_EXPANSION_B30, evidenceVersion:DRINK_MASTER_EXPANSION_B30_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B30_EVALUATED_AT };
const B31_BATCH={ id:'B31', drinks:DRINK_MASTER_EXPANSION_B31, evidenceVersion:DRINK_MASTER_EXPANSION_B31_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B31_EVALUATED_AT };
const B32_BATCH={ id:'B32', drinks:DRINK_MASTER_EXPANSION_B32, evidenceVersion:DRINK_MASTER_EXPANSION_B32_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B32_EVALUATED_AT };
const B33_BATCH={ id:'B33', drinks:DRINK_MASTER_EXPANSION_B33, evidenceVersion:DRINK_MASTER_EXPANSION_B33_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B33_EVALUATED_AT };
const B34_BATCH={ id:'B34', drinks:DRINK_MASTER_EXPANSION_B34, evidenceVersion:DRINK_MASTER_EXPANSION_B34_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B34_EVALUATED_AT };
const B35_BATCH={ id:'B35', drinks:DRINK_MASTER_EXPANSION_B35, evidenceVersion:DRINK_MASTER_EXPANSION_B35_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B35_EVALUATED_AT };
const B36_BATCH={ id:'B36', drinks:DRINK_MASTER_EXPANSION_B36, evidenceVersion:DRINK_MASTER_EXPANSION_B36_EVIDENCE_VERSION, evaluatedAt:DRINK_MASTER_EXPANSION_B36_EVALUATED_AT };
...
for (const batch of [...EXPANSION_BATCHES,B23_BATCH,B24_BATCH,B25_BATCH,B26_BATCH,B27_BATCH,B28_BATCH,B29_BATCH,B30_BATCH,B31_BATCH,B32_BATCH,B33_BATCH,B34_BATCH,B35_BATCH,B36_BATCH,B37_BATCH,B38_BATCH]) {
