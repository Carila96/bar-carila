...
async function addMasterKeyInstruction(request) {
  ...
  const barCarilaStage = typeof body.barCarilaStage === 'string' ? body.barCarilaStage : '';
  ...
  body.system += barCarilaStage === 'selection'
